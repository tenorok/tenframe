...
/*    Использование
    ...
    Преобразование URI в транслит:
        var translit = tenframe.text('Текст для перевода').translitUri();
*/

tenframe.text = function(text) {

    if(!(this instanceof tenframe.text)) return new tenframe.text(text);
 ...
 * @return string
 */
tenframe.text.prototype.translitUri = function() {
