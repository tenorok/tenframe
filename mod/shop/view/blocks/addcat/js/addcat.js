BEM.DOM.decl('mod-shop-addcat', {
    ...
    onSetMod: {
        ...
        js: function() {
            this._fieldHtml = this.elem('fielditem').htmlWithParent();                  // Получение html-структуры добавления поля категории
        }
    ...
    changeExistList: function() {                                                       // Демонстрация и скрытие полей для ввода при изменении выпадающего списка "Новое поле" и выбора уже существующих полей
        ...
        var $select = this.elem('existfield'),
    ...
    live: function() {
        ...
        this
            .liveBindTo('catname', 'keyup', function() {                                // Событие ввода названия категории
                this.setAlias();
            })
            .liveBindTo('existfield', 'change', function() {
                this.changeExistList();
            })
            .liveBindTo('textinput', 'keyup', function() {
//                this.addField();
            })
            .liveBindTo('checkboxinput', 'change', function() {
//                this.changeClassifier();
            })
            .liveBindTo('classifier', 'keyup', function() {
//                this.addClassifierValue();
            });
